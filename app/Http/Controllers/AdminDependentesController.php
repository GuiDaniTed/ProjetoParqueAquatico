<?php namespace App\Http\Controllers;
	...
	class AdminDependentesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Certidao','name'=>'certidao','type'=>'upload','validation'=>'required|min:1|max:255|image|image','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'E-mail','name'=>'email','type'=>'email','validation'=>'required|min:1|max:40|email|unique:dependentes','width'=>'col-sm-10','placeholder'=>'Please enter a valid email address'];
